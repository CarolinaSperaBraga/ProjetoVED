        ...
        tabItems(
            ...
            tabItem(tabName = "graficos-linha",
                    fluidRow(
                        ...
                        column(width=6,
                               selectInput("pais", "Escolha o país", paises)
                    ...
                    fluidRow(
                        ...
                        column(width=6,
                               selectInput("var0", "Escolha uma variável dependente:",
                                           choices = c("Mortalidade infantil", "Mediana das idades", "PIB per capita",
